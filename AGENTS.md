...
- `examples/opencode/sbxenv.yaml` — optionales deklaratives Environment (`sbx env`, experimentell, sbx ≥ 0.43) als Alternative zum `sbx run`-Weg; Template-Pin wird vom Validate-Check (`--validate-only`) und Renovate mitgetrackt (Issue #120)
