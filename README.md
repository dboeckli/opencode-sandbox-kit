...
### Template-Version & Tooling-Image-Tags (gepinnt, Renovate-managed)
...
> ```powershell
> python local-test\build-and-publish-mistral-vibe-image.py
> ```
> Nur pushen:
> ```powershell
> python local-test\build-and-publish-mistral-vibe-image.py --no-load
> ```
> Nur bauen:
> ```powershell
